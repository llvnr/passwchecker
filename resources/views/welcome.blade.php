...
<head>
    ...
    <meta name="description" content="Un service qui vous permet de vérifier la performance d'un mot de passe.">
    <title>Passwchecker - Un service qui vous permet de vérifier la performance d'un mot de passe.</title>
